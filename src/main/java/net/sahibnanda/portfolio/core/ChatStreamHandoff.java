...
/**
 * The result of a streaming chat handoff: either a context for processing or an
 * error. Exactly one of the two fields is non-null.
 *
 ...
 */
public record ChatStreamHandoff(ChatStreamContext context,
